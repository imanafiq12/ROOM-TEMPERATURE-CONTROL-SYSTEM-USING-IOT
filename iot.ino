...
#define BLYNK_TEMPLATE_ID "TMPL6BD1LB5Kh"
#define BLYNK_TEMPLATE_NAME "Quickstart Template"
#define BLYNK_AUTH_TOKEN "pZ5cuafyYyWHSeSR31wwlq6fVOYX1QOE"
// Your WiFi credentials.
// Set password to "" for open networks.
//char ssid[] = "Gula gula plastik";
//char pass[] = "1000pluss";
char ssid[] = "iman";
char pass[] = "12345678";
#include <WiFi.h>
...
void checkBlynkStatus() { // called every 2 seconds by SimpleTimer
  ...
  if (isconnected == true) {
    ...
    Blynk.virtualWrite(VPIN_Text, "by iman and harith");
  }
  display.display();
  delay(1000);
}
...
void sendSensor()
{
  ...
  Blynk.virtualWrite(VPIN_Text, "Room temp control system");
